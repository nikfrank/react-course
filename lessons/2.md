...
- [step 0: user input from our input boxes (( style ))](#step0)
- [step 1: Dropdown selections (( style ))](#step1)
- [step 2: Validation (( style error message to be a pop-up box ))](#step2)
- [step 3: Date inputs](#step3)

- [step 4: clicking on snoop: Simple React Components](#step4)
- [step 5: toastr for failed submission](#step5)
- [step 6: parallax gold record ak-47](#step6)
...
if you're starting from this step `$ git checkout step0` [git cheat sheet](./git.md)
...
if you're starting from this step `$ git checkout step1` [git cheat sheet](./git.md)
...
if you're starting from this step `$ git checkout step2` [git cheat sheet](./git.md)
...
if you're starting from this step `$ git checkout step3` [git cheat sheet](./git.md)
...
if you're starting from this step `$ git checkout step4` [git cheat sheet](./git.md)
...
if you're starting from this step `$ git checkout step5` [git cheat sheet](./git.md)
...
### step 6: parallax gold record ak-47 

if you're starting from this step `$ git checkout step6` [git cheat sheet](./git.md)
