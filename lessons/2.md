...
### concepts: using `setState` for forms <a name="concepts"></a>
...
### getting started step: clicking a button <a name="start"></a>
...
### step 0: user input from our input boxes <a name="step0"></a>
...
### step 1: Dropdown selections <a name="step1"></a>
...
### step 2: Validation <a name="step2"></a>
...
### step 3: Date inputs <a name="step3"></a>
...
### step 4: clicking on snoop: Simple React Components <a name="step4"></a>
...
### step 5, toastr for failing submission <a name="step5"></a>
...
### step 6: parallax gold record ak-47 <a name="step6"></a>
