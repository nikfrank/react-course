...
### step 5 pure components (optional)

the way we wrote our Components in step4 (without using state or instance methods) allows us to rewrite them as [functional components](https://medium.com/@PhilipAndrews/react-how-to-access-props-in-a-functional-component-6bd4200b9e0b)

(I don't really like any of the articles available about functional components... I should write one, but for now, that'll have to do)
